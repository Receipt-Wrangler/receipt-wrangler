...
import { SetOrderBy, SetPage, SetPageSize, SetSortDirection } from "./report-template-table.state.actions";

@State<PagedTableInterface>({
  name: "reportTemplateTable",
  defaults: {
    page: 1,
    pageSize: 50,
    orderBy: "updated_at",
...
@Injectable()
export class ReportTemplateTableState extends PagedTableState {
  @Action(SetPage)
