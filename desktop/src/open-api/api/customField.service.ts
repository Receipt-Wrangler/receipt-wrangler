...
export class CustomFieldService {
     ...
     * @param customFieldId Custom field Id to get
     * @param upsertCustomFieldCommand Custom field data to update
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateCustomField(customFieldId: number, upsertCustomFieldCommand: UpsertCustomFieldCommand, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<CustomField>;
    public updateCustomField(customFieldId: number, upsertCustomFieldCommand: UpsertCustomFieldCommand, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<CustomField>>;
    public updateCustomField(customFieldId: number, upsertCustomFieldCommand: UpsertCustomFieldCommand, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<CustomField>>;
    public updateCustomField(customFieldId: number, upsertCustomFieldCommand: UpsertCustomFieldCommand, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (customFieldId === null || customFieldId === undefined) {
            throw new Error('Required parameter customFieldId was null or undefined when calling updateCustomField.');
        }
        if (upsertCustomFieldCommand === null || upsertCustomFieldCommand === undefined) {
            throw new Error('Required parameter upsertCustomFieldCommand was null or undefined when calling updateCustomField.');
        }
        ...
        let localVarPath = `/customField/${this.configuration.encodeParam({name: "customFieldId", value: customFieldId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: undefined})}`;
        return this.httpClient.request<CustomField>('put', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: upsertCustomFieldCommand,
                responseType: <any>responseType_,
