...
class OidcProviderApi {
  ...
  const OidcProviderApi(this._dio, this._serializers);

  /// Create an OIDC provider
  /// 
  ///
  /// Parameters:
  /// * [upsertOidcProviderCommand] - The provider configuration
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OidcProviderView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OidcProviderView>> createOidcProvider({ 
    required UpsertOidcProviderCommand upsertOidcProviderCommand,
    ...
    try {
      const _type = FullType(UpsertOidcProviderCommand);
      _bodyData = _serializers.serialize(upsertOidcProviderCommand, specifiedType: _type);
    ...
    OidcProviderView? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OidcProviderView),
      ) as OidcProviderView;
    ...
    return Response<OidcProviderView>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOidcProvider({ 
    required String oidcProviderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/oidcProvider/{oidcProviderId}'.replaceAll('{' r'oidcProviderId' '}', encodeQueryParameter(_serializers, oidcProviderId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [OidcProviderView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OidcProviderView>> getOidcProviderById({ 
    required String oidcProviderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedData>> getPagedOidcProviders({ 
    ...
    final _path = r'/oidcProvider/getPagedOidcProviders';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [OidcProviderView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OidcProviderView>> updateOidcProvider({ 
    required String oidcProviderId,
    required UpsertOidcProviderCommand upsertOidcProviderCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
