...
class OidcApi {
  ...
  Future<Response<void>> deleteOidcConnection({ 
    ...
    final _path = r'/oidc/connections/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<OidcConnectionView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<OidcConnectionView>>> getOidcConnections({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/oidc/connections';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<OidcConnectionView>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(OidcConnectionView)]),
      ) as BuiltList<OidcConnectionView>;
    ...
    return Response<BuiltList<OidcConnectionView>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oidcCallback({ 
    required String name,
    String? code,
    String? state,
    CancelToken? cancelToken,
    ...
    final _path = r'/oidc/{name}/callback'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [oidcExchangeCommand] - The code and the app's PKCE verifier
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppData>> oidcExchange({ 
    required OidcExchangeCommand oidcExchangeCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(OidcExchangeCommand);
      _bodyData = _serializers.serialize(oidcExchangeCommand, specifiedType: _type);
  ...
  Future<Response<OidcLinkStartView>> oidcLinkStart({ 
    ...
    final _path = r'/oidc/link/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [name] - The provider's slug
  /// * [client] - Which client is signing in. Mobile receives a single-use exchange code on the app's private-use URL scheme instead of session cookies.
  /// * [codeChallenge] - The mobile app's own PKCE S256 challenge. Required when client is mobile; it binds the resulting exchange code to the app that started the flow.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oidcLogin({ 
    required String name,
    String? client = 'desktop',
    ...
    final _path = r'/oidc/{name}/login'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (client != null) r'client': encodeQueryParameter(_serializers, client, const FullType(String)),
      if (codeChallenge != null) r'codeChallenge': encodeQueryParameter(_serializers, codeChallenge, const FullType(String)),
    };
