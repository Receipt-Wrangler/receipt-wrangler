...
class RoleApi {
  ...
  ///
  /// Parameters:
  /// * [upsertRoleCommand] - Role to create
  ...
  Future<Response<Role>> createRole({ 
    required UpsertRoleCommand upsertRoleCommand,
    ...
    try {
      const _type = FullType(UpsertRoleCommand);
      _bodyData = _serializers.serialize(upsertRoleCommand, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [scope] - Scope of the role to delete
  ...
  Future<Response<void>> deleteRole({ 
    ...
    final _path = r'/role/{roleId}'.replaceAll('{' r'roleId' '}', encodeQueryParameter(_serializers, roleId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'scope': encodeQueryParameter(_serializers, scope, const FullType(PermissionScope)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Role>>> getRoles({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  ///
  /// Parameters:
  /// * [scope] - Scope of the role to make default
  /// * [roleId] - Id of the role to make the default for its scope
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Role] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Role>> setDefaultRole({ 
    required PermissionScope scope,
    required int roleId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/role/{roleId}/default'.replaceAll('{' r'roleId' '}', encodeQueryParameter(_serializers, roleId, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [roleId] - Id of the role to update
  /// * [upsertRoleCommand] - Role to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
