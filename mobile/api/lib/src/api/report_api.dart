...
class ReportApi {
  ...
  ///
  /// Parameters:
  /// * [reportRequestCommand] - The report builder configuration to save
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ReportTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReportTemplate>> createReportTemplate({ 
    required ReportRequestCommand reportRequestCommand,
    ...
    try {
      const _type = FullType(ReportRequestCommand);
      _bodyData = _serializers.serialize(reportRequestCommand, specifiedType: _type);
    ...
    ReportTemplate? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReportTemplate),
      ) as ReportTemplate;
    ...
    return Response<ReportTemplate>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the report template to delete
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteReportTemplate({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/report/template/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the report template to duplicate
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [ReportTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReportTemplate>> duplicateReportTemplate({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/report/template/{id}/duplicate'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [reportRequestCommand] - The report builder configuration
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> generateReport({ 
    required ReportRequestCommand reportRequestCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the report template to generate
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Uint8List] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> generateReportFromTemplate({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/report/template/{id}/generate'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedData>> getReportReceipts({ 
    required ReportRequestCommand reportRequestCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the report template to get
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [ReportTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReportTemplate>> getReportTemplate({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ReportTemplateOption>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ReportTemplateOption>>> getReportTemplateOptions({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/report/template/options';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ReportTemplateOption>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ReportTemplateOption)]),
      ) as BuiltList<ReportTemplateOption>;
    ...
    return Response<BuiltList<ReportTemplateOption>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PagedData] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedData>> getReportTemplates({ 
    ...
    final _path = r'/report/template/list';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReportPreviewResponse>> previewReport({ 
    required ReportRequestCommand reportRequestCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [id] - Id of the report template to update
  /// * [reportRequestCommand] - The report builder configuration to save over the existing template
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [ReportTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReportTemplate>> updateReportTemplate({ 
    required int id,
    required ReportRequestCommand reportRequestCommand,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
